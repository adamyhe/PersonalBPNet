...
class PauseNet(torch.nn.Module):
    ...
    IMPORTANT NOTE: this flag is currently bugged and needs fixing).
    """
    ...
    def __init__(
        ...
        try:
            ...
            print(
                "Base model does not have a batch normalization layer in the "
                "counts head. We'll skip adding it."
            )
